...
const SEED_FOODS = [
  ...
  // ── Lean proteins ─────────────────────────────────────────────
  ['Chicken breast (air-fried, minimal oil)', 'staple', '100g', 100, 175, 31, 0, 5, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5},{unit:'200g',multiplier:2}]), null],
  ['Chicken breast (grilled)',               'staple', '100g', 100, 165, 31, 0, 4, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5},{unit:'200g',multiplier:2}]), null],
  ['Chicken breast (curry, home-style)',     'home-cooked', '1 cup', 240, 240, 30, 8, 9, 1, 3, null, null],
  ['Chicken thigh (air-fried, skinless)',    'staple', '100g', 100, 215, 26, 0, 12, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Chicken keema (lean, home-style)',       'home-cooked', '1 cup', 240, 280, 28, 6, 16, 1, 2, null, null],
  ['Fish curry (home-style)',                'home-cooked', '1 cup', 240, 260, 22, 8, 16, 1.5, 3, null, null],
  ['Basa fish curry (home-style)',           'home-cooked', '1 cup', 240, 250, 20, 9, 15, 1.5, 3, null, null],
  ['Basa fillet (air-fried/grilled)',        'staple', '100g', 100, 105, 18, 0, 3, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Rohu/pomfret (grilled)',                 'staple', '100g', 100, 145, 22, 0, 6, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Tuna (canned in water, drained)',        'staple', '100g', 100, 116, 26, 0, 1, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Prawns (air-fried, light oil)',          'staple', '100g', 100, 140, 24, 1, 4.5, 0, 0,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Egg whites',                             'staple', '100g (~3 whites)', 100, 52, 11, 0.7, 0.2, 0, 0.7,
    JSON.stringify([{unit:'100g (~3 whites)',multiplier:1},{unit:'6 whites',multiplier:2}]), null],
  ['Paneer (regular)',                       'staple', '100g', 100, 265, 18, 6, 20, 0, 5,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'50g',multiplier:0.5}]), null],
  ['Paneer (low-fat)',                       'staple', '100g', 100, 180, 20, 6, 8, 0, 5,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'50g',multiplier:0.5}]), null],
  ['Paneer tikka (air-fried)',               'staple', '100g', 100, 220, 19, 7, 13, 0.5, 4,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Tofu (firm)',                            'staple', '100g', 100, 145, 16, 3, 8, 1, 1,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Soya chunks (dry weight)',               'staple', '50g', 50, 172, 26, 16, 0.5, 6.5, 1,
    JSON.stringify([{unit:'50g',multiplier:1},{unit:'100g',multiplier:2}]), null],
  ['Soya chunk curry (home-style)',          'home-cooked', '1 cup', 240, 240, 24, 18, 9, 6, 4, null, null],

  // ── Legumes & volume carbs ────────────────────────────────────
  ['Boiled chana (kala/white)',              'home-cooked', '1 cup', 240, 269, 15, 45, 4, 12.5, 8,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'1/2 cup',multiplier:0.5}]), null],
  ['Sprouts (moong, boiled)',                'home-cooked', '1 cup', 240, 62, 6, 12, 0.4, 2, 4, null, null],
  ['Rajma (boiled, no gravy)',               'home-cooked', '1 cup', 240, 225, 15, 40, 1, 11, 1,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'1/2 cup',multiplier:0.5}]), null],
  ['Brown rice (steamed)',                   'staple', '1 cup', 150, 215, 5, 45, 1.8, 3.5, 0,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'1/2 cup',multiplier:0.5}]), null],
  ['Quinoa (cooked)',                        'staple', '1 cup', 185, 222, 8, 39, 3.6, 5, 1.6,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'1/2 cup',multiplier:0.5}]), null],
  ['Whole wheat bread',                      'staple', '1 slice', 1, 80, 4, 14, 1, 2, 1.5,
    JSON.stringify([{unit:'1 slice',multiplier:1},{unit:'2 slices',multiplier:2}]), null],
  ['Multigrain roti',                        'staple', '1 piece', 1, 95, 4, 16, 2, 3, 0.5,
    JSON.stringify([{unit:'1 piece',multiplier:1},{unit:'2 pieces',multiplier:2}]), null],
  ['Sweet potato (boiled)',                  'staple', '100g', 100, 86, 1.6, 20, 0.1, 3, 4.2,
    JSON.stringify([{unit:'100g',multiplier:1},{unit:'150g',multiplier:1.5}]), null],
  ['Air-fried potato wedges (light oil)',    'snack', '100g', 100, 130, 2.5, 25, 3, 3, 1.2, null, null],

  // ── High-volume vegetables ────────────────────────────────────
  ['Cabbage (raw/steamed)',                  'snack', '1 cup', 1, 22, 1.1, 5, 0.1, 2.2, 2.8, null, null],
  ['Carrot (raw)',                           'snack', '1 medium', 1, 25, 0.6, 6, 0.1, 1.7, 2.9, null, null],
  ['Capsicum/bell pepper',                   'snack', '1 medium', 1, 30, 1, 7, 0.3, 2.5, 4.2, null, null],
  ['Broccoli (steamed)',                     'snack', '1 cup', 1, 55, 3.7, 11, 0.6, 5, 2.2,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'2 cups',multiplier:2}]), null],
  ['Cauliflower (steamed)',                  'snack', '1 cup', 1, 29, 2.3, 5, 0.3, 2.9, 2, null, null],
  ['Spinach (cooked)',                       'home-cooked', '1 cup', 1, 41, 5.3, 6.7, 0.5, 4.3, 0.8, null, null],
  ['Green beans (steamed)',                  'snack', '1 cup', 1, 44, 2.4, 10, 0.3, 4, 4.6, null, null],
  ['Mixed salad (cucumber, tomato, onion, lemon)', 'snack', '1 bowl', 1, 45, 2, 9, 0.3, 2.5, 5, null, null],
  ['Raita (curd + cucumber)',                'home-cooked', '1 cup', 240, 95, 6, 8, 4, 0.7, 6,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'1/2 cup',multiplier:0.5}]), null],

  // ── Snacks & extras ───────────────────────────────────────────
  ['Epigamia protein shake',                 'snack', '1 bottle', 1, 139, 25, 6, 1.5, 0, 3, null, null],
  ['Peanut butter',                          'snack', '1 tbsp', 1, 95, 3.5, 3.5, 8, 1, 1.5,
    JSON.stringify([{unit:'1 tbsp',multiplier:1},{unit:'2 tbsp',multiplier:2}]), null],
  ['Walnuts',                                'snack', '5 halves', 5, 65, 1.5, 1.4, 6.5, 0.7, 0.3,
    JSON.stringify([{unit:'5 halves',multiplier:1},{unit:'10 halves',multiplier:2}]), null],
  ['Roasted chana (dry)',                    'snack', '30g', 30, 115, 6, 18, 1.8, 5, 0,
    JSON.stringify([{unit:'30g',multiplier:1},{unit:'50g',multiplier:1.67}]), null],
  ['Makhana (roasted, light oil)',           'snack', '30g', 30, 105, 3, 22, 0.5, 2, 0,
    JSON.stringify([{unit:'30g',multiplier:1},{unit:'50g',multiplier:1.67}]), null],
  ['Popcorn (air-popped)',                   'snack', '30g', 30, 110, 3.5, 22, 1.3, 4, 0.2,
    JSON.stringify([{unit:'30g',multiplier:1},{unit:'50g',multiplier:1.67}]), null],
  ['Watermelon',                             'snack', '1 cup', 1, 46, 0.9, 11.5, 0.2, 0.6, 9.4,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'2 cups',multiplier:2}]), null],
  ['Papaya',                                 'snack', '1 cup', 1, 62, 0.7, 16, 0.4, 2.5, 11,
    JSON.stringify([{unit:'1 cup',multiplier:1},{unit:'2 cups',multiplier:2}]), null],
  ...
  ['Olive oil',                              'staple', '1 tsp', 1, 40, 0, 0, 4.5, 0, 0,
    JSON.stringify([{unit:'1 tsp',multiplier:1},{unit:'1 tbsp',multiplier:3}]), null],
  ['Ghee',                                   'staple', '1 tsp', 1, 45, 0, 0, 5, 0, 0,
    JSON.stringify([{unit:'1 tsp',multiplier:1},{unit:'1 tbsp',multiplier:3}]), null],
  ['Refined/vegetable oil',                  'staple', '1 tsp', 1, 40, 0, 0, 4.5, 0, 0,
    JSON.stringify([{unit:'1 tsp',multiplier:1},{unit:'1 tbsp',multiplier:3}]), null],
  ['Butter',                                 'staple', '1 tsp', 1, 34, 0, 0, 3.8, 0, 0,
    JSON.stringify([{unit:'1 tsp',multiplier:1},{unit:'1 tbsp',multiplier:3}]), null],
];
